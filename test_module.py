...
class UnitTests(unittest.TestCase):
    def test_calculate(self):
        ...
        expected = {
            ...
            'standard deviation': [[3.091206165165235, 0.816496580927726, 2.943920288775949], [1.8856180831641267, 3.265986323710904, 2.494438257849294], 2.6435136701979676],
            'max': [[8, 6, 7], [6, 8, 7], 8],
            'min': [[1, 4, 0], [2, 0, 1], 0],
    ...
    def test_calculate2(self):
        ...
        expected = {
            ...
            'variance': [[9.555555555555555, 11.555555555555557, 4.222222222222222], [10.666666666666666, 0.0, 14.888888888888891], 9.209876543209877],
